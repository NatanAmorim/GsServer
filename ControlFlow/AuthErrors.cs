namespace gs_server.ControlFlow.Auth;

// MissingCredentials: This error occurs when the user doesn't provide both the email and password required for authentication. The user is prompted to enter both the email and password to proceed.
// InvalidCredentials: This error arises when the provided email and password combination is not valid. It indicates that the user's authentication credentials are incorrect and they need to provide accurate credentials to log in.
