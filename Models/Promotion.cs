...
public class PromotionModel // Represents special offers or discounts.
{
  ...
  public required string Name { get; set; } // Name of the offer (e.g., "Summer Sale", "Introductory Discount", "Free Trials", "Referral Bonuses").
  public required string Description { get; set; }
  public required string DiscountType { get; set; } // Type of discount offered (e.g., "percentage", "fixed amount").
  public required DateOnly StartDate { get; set; } // Date the offer becomes active.
  public required DateOnly EndDate { get; set; } // Date the offer expires (optional).
